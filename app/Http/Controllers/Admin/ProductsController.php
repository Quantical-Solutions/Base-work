...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        $results = Product::select('*')->orderBy('id', 'desc')->get()->toArray();
        $count = count($results);
        ...
        return view('admin/tools/scrud', ['title' => 'Produits', 'scrud' => $scrud]);
    }

    public function mode($mode, $id = false)
    {
        return view('admin/tools/edit-read', ['title' => 'Produit']);
    }
}
